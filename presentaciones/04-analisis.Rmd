...
knitr::include_graphics("_include/05-pasos-1.png")
```
...
knitr::include_graphics("_include/05-pasos-2.png")
```
...
```{r, out.height = 450, out.width = 1000, fig.align = "center", echo = FALSE}
knitr::include_graphics("_include/05-pasos-3.png")
```
...
knitr::include_graphics("_include/hex/tidyverse.png")
```
]
...
knitr::include_graphics("_include/05-meta-tidyverse.png")
```
...
```{r, out.height = 450, out.width = 1000, fig.align = "center", echo = FALSE}
knitr::include_graphics("_include/cubre-tidyverse.png")
```
...
knitr::include_graphics("_include/05-paquetes-leer.png")
```
]
.right-column[
...
knitr::include_graphics("_include/05-paquetes-ordenar.png")
```
]
.right-column[
...
.left-column[
```{r, out.height = 300, out.width = 280, fig.align = "center", echo = FALSE}
knitr::include_graphics("_include/hex/ggplot2.png")
```
]
.right-column[
...
.left-column[
```{r, out.height = 300, out.width = 280, fig.align = "center", echo = FALSE}
knitr::include_graphics("_include/hex/purrr.png")
```
]
.right-column[
...
### **Archivo:** 04-tidyverse-1.Rmd & 05-tidyverse-2.Rmd

---
class: exercise, middle, center
## Ejercicio
# Analizar Datos con el `tidyverse`
### **Archivo:** 06-fechas.Rmd & 07-texto.Rmd
